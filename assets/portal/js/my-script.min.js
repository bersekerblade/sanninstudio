$(function () {
	$("#sidebar-left").simplerSidebar({
		...
		sidebar: { width: 375 },
		gap: 0,
		selectors: { trigger: "#sidebar-left-trigger", quitter: "#sidebar-close" },
	...
	$(function () {
		$(".hero-home").slick({
			...
			responsive: [
				{
					breakpoint: 1200,
					settings: { centerMode: !0, centerPadding: "20%" },
				},
				{ breakpoint: 768, settings: { centerMode: !0, centerPadding: "10%" } },
				{ breakpoint: 480, settings: { centerMode: !0, centerPadding: "5%" } },
			],
		});
	}),
	$(function () {
	...
	$(function () {
		var e = $(".campaign_videocall_schedule");
		e.slick({
			infinite: !0,
			dots: !0,
			arrows: !1,
			...
			$("#jadwal-videocall-button").click(function () {
				e.css("opacity", 0),
	...
	$(function () {
		var e = $(".campaign_privatetalk_schedule");
		e.slick({
			infinite: !0,
			dots: !0,
			arrows: !1,
			...
			$("#jadwal-privatetalk-button").click(function () {
				e.css("opacity", 0),
					e.animate({ "z-index": 1 }, 300, function () {
						e.slick("setPosition"), e.animate({ opacity: 1 });
					});
