...
(jQuery.trumbowyg = {
	...
	(function (e, t, n, a) {
		...
		var i = function (o, r) {
			...
			if (
				((i.hasSvg = !1 !== d),
				!1 !== d && (l.svgAbsoluteUseHref || 0 === a("#" + s, i.doc).length))
			) {
				if (null == d)
			...
			var u = i.doc.querySelector("base")
				? t.location.href.replace(t.location.hash, "")
				: "";
		...
		i.prototype = {
			...
			buildEditor: function () {
				...
				(e.$box = a("<div/>", {
					...
					e.isTextarea
						? ((o = e.$ta.val()),
						  (e.$ed = a("<div/>").appendTo(e.$edBox)),
						  e.$box.insertAfter(e.$ta).append(e.$edBox, e.$ta))
						: ((e.$ed = e.$ta),
						  (o = e.$ed.html()),
						  (e.$ta = a("<textarea/>", {
								name: e.$ta.attr("id"),
						  ...
						  e.$box.insertAfter(e.$ed).append(e.$ta, e.$edBox),
						  e.$edBox.append(e.$ed),
						  e.syncCode()),
				...
				e.$ed
					...
					.on("input", function (t) {
						...
						"object" == typeof n &&
							("insertReplacementText" === n.inputType ||
								("insertText" === n.inputType && null === n.data)) &&
					...
					.on("focus blur", function (t) {
						if (
							...
							"focus" === t.type
								...
								: e.o.autogrow ||
								  (e.$edBox.css({ height: e.$edBox.css("min-height") }),
			...
			syncCode: function (e) {
				...
				if (
					...
					r !== t.$ta.css("height") &&
						(t.$edBox.css({ height: r }), t.$c.trigger("tbwresize"));
				}
			},
			...
			createLink: function () {
				...
				if (s && "A" === s.nodeName) {
					...
					(l = c.text()),
						(e = c.attr("href")),
						o.o.minimalLinks ||
							((t = c.attr("title")), (n = c.attr("target") || d));
				...
				if (!o.o.minimalLinks) {
					...
					a.extend(g, {
						...
						target: { label: o.lang.target, value: n, options: f },
					});
				}
				o.openModalInsert(o.lang.createLink, g, function (e) {
					...
					return (
						...
						(e.target || d) && n.attr("target", e.target || d),
			...
			openModal: function (e, n, i) {
				...
				return (
					...
					i &&
						(a(":input:first", g).focus(),
						s.buildModalBtn("submit", g),
						s.buildModalBtn("reset", g),
						c.height(g.outerHeight() + 10)),
					a(t).trigger("scroll"),
				...
				return (
					a.each(t, function (e, t) {
						...
						if ("function" == typeof t.type)
							return t.name || (t.name = o), void (d += t.type(t, i, s, l));
